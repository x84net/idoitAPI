#!/usr/bin/env python3
"""
Example-Script for i-doit API class - add a new switch / create new switch object
"""
...
if __name__ == "__main__":
    ...
    res = pyDoit.get_category_by_obj_id(3077, 'C__CATG__MODEL')
    log.info("'C__CATG__MODEL':\n{}".format(json.dumps(res, indent=4)))

    res = pyDoit.get_category_by_obj_id(3077, 'C__CATG__FORMFACTOR')
    log.info("'C__CATG__FORMFACTOR':\n{}".format(json.dumps(res, indent=4,)))

    res = pyDoit.get_category_by_obj_id(3077,  'C__CATG__LOCATION')
    ...
    """
    res = pyDoit.get_category_from_object(res['id'], 'C__CATG__LOCATION')
    log.info("Switch: \n{}".format(json.dumps(res, indent=4)))
    """